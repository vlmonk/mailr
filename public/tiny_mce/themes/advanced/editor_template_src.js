...
var TinyMCE_advanced_buttons = [
	...
	['link', 'link.gif', '{$lang_link_desc}', 'mceLink', true],
        ['attachment', 'attachment.gif', '{$lang_attachment_desc}', 'mceAttachment', true],
...
function TinyMCE_advanced_getControlHTML(button_name)
{
	var buttonTileMap = new Array('anchor.gif','backcolor.gif','bullist.gif','center.gif',
											...
											'image.gif','indent.gif','left.gif','link.gif','attachment.gif','numlist.gif',
...
function TinyMCE_advanced_getEditorTemplate(settings, editorId)
{
	...
	switch(layoutManager)
	{
		case "SimpleLayout" : //the default TinyMCE Layout (for backwards compatibility)...
			...
			// Render row 2
			var buttonNamesRow2 = tinyMCE.getParam("theme_advanced_buttons2", "bullist,numlist,separator,outdent,indent,separator,undo,redo,separator,link,unlink,attachment,anchor,image,cleanup,help,code", true, ',');
															  ...
															  undo_levels, visual_aid, any_selection)
{
	...
	tinyMCE.switchClassSticky(editor_id + '_link', 'mceButtonDisabled', true);
        tinyMCE.switchClassSticky(editor_id + '_attachment', 'mceButtonDisabled', true);
   ...
   tinyMCE.switchClassSticky(editor_id + '_hr', 'mceButtonNormal');
	...
	if (anchorLink || any_selection)
	{
		tinyMCE.switchClassSticky(editor_id + '_link', anchorLink ? 'mceButtonSelected' : 'mceButtonNormal', false);
                tinyMCE.switchClassSticky(editor_id + '_attachment', anchorLink ? 'mceButtonSelected' : 'mceButtonNormal', false);
